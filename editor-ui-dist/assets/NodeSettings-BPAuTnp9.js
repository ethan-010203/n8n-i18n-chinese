...
import { Bt as useNDVStore, C as useNodeTypesStore, Ea as COMMUNITY_NODES_INSTALLATION_DOCS_URL, It as useNodeHelpers, Kt as ProjectTypes, Lt as useTelemetry, R as removePreviewToken, Rr as useWorkflowsListStore, Tt as useWorkflowHelpers, Vt as injectWorkflowState, _a as importCurlEventBus, fi as useHistoryStore, ka as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, w as useActionsGenerator, ws as useSettingsStore, xi as RenameNodeCommand, xr as useExternalHooks, yr as useToast } from "./users.store-DURTr6JZ.js";
import { O as NodeCredentials_default, d as useNodeSettingsParameters, f as collectParametersByTab, g as getNodeSettingsInitialValues, j as TitledList_default, k as useNodeCredentialOptions, m as createCommonNodeSettings, p as collectSettings, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-D97RXwD2.js";
import { n as ElRow, t as ElCol } from "./col-DYLaQhBS.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, Ha as deepCopy, I as CUSTOM_API_CALL_KEY, Jn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Nn as MCP_TRIGGER_NODE_TYPE, Oo as OPEN_AI_API_CREDENTIAL_TYPE, Ua as isCommunityPackageName, Zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, d as CUSTOM_NODES_DOCS_URL, en as DATA_TABLE_NODES, fa as getNodeParameters, gn as FORM_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, rs as VIEWS, s as BASE_NODE_SURVEY_URL, so as NodeConnectionTypes, ua as getNodeInputs, x as NPM_PACKAGE_DOCS_BASE_URL } from "./constants-nyGOVcBV.js";
import { t as useDebounce } from "./useDebounce-BrqlJugT.js";
...
import { a as useInstalledCommunityPackage, i as ContactAdministratorToInstall_default, n as CommunityNodeUpdateInfo_default, o as useInstallNode, r as CommunityNodeFooter_default, t as QuickConnectBanner_default } from "./QuickConnectBanner-BFHHuFQi.js";
import { t as useQuickConnect } from "./useQuickConnect-D-jQojXO.js";
import { t as NodeIcon_default } from "./NodeIcon-BenTnQgt.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-Bopg1LqE.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-BcuwYbGV.js";
